...
namespace Binex.Helper.StaticInfo
{
    public static class Types
    {
        ...
        {
            public static ViewInfo BinancePay = new ViewInfo { Name = "Оплата Binance", View = new Guid("38E7686B-4F2C-4F72-95DA-08CF3CA249BC"), Num = 0, ModelClass = ModelBaseClasses.LeftMenu };
